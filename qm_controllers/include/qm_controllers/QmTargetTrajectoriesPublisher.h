...
namespace qm
{
    ...
    public:
              ...
              eeCmdVelToTargetTrajectories_(std::move(eeCmdVelToTargetTrajectories))
        {
            ...
            markerCmdVelSub_ = nh.subscribe<visualization_msgs::InteractiveMarkerFeedback>("/marker_pose", 1, markerVelCallback);
    ...
    private:
        ...
        ::ros::Subscriber observationSub_, eePoseSub_, dogCmdVelSub_, eeCmdVelSub_, markerCmdVelSub_, markerPoseSub_;
